<div class="entidad-container">
	...
	<div class="entidad-box">
		...
		?>
			<li>
				...
				<div class="entidad-item-edit"><a href="" title="Editar"><i class="fa fa-pencil-square-o fa-lg"></i></a></div>
	...
	<div class="entidad-box">
		...
		<div class="entidad-content">
			...
			<form action="modulos/module.AgregarEntidad.php" class="form-entidad" method="POST">
				
				<input type="text" name="ent-cod" class="cod-ent-input" placeholder="Código">

				<input type="text" name="ent-nombre" placeholder="Nombre Entidad">

				<input type="submit" class="btn btn-primary btn-large ent-submit" name="grabar-entidad" value="Grabar" />
